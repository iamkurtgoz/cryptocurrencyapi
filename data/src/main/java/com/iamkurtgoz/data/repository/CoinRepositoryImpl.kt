...
import com.iamkurtgoz.contract.model.mapOnSuccess
...
internal class CoinRepositoryImpl @Inject constructor(
    ...
    override suspend fun getCoinList(vsCurrency: String?, page: Int?, perPage: Int?): List<CoinUIModel> {
        ...
        return if (useCache) {
            ...
            coinMapper.mapEntityToUiModel(coinDao.getCoins(limit = perPage, offset = page))
        }
    }
